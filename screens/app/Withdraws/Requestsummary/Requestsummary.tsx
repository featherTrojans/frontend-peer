  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={{ flex: 1 }}>
        ...
        >
          ...
          <Priceandcharges
            ...
            charges={+requestInfo?.charges + +requestInfo?.negotiatedFee}
          />
        </View>
        ...
        <View style={styles.saferulesContainer}>
          ...
          <Text style={styles.saferuleText}>
            2. Ensure that the cash given to you is certified as “in good
            condition” by you.
          </Text>
          <Text style={styles.saferuleText}>
      ...
      <Bottombtn
        ...
        onpress={() => navigation.push("Summary", { requestInfo })}
      />
    </SafeAreaView>
  );
};
