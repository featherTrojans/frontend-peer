  ...
  const getUser = async () => {
    try {
      const response = await axiosCustom.get(`/user/${userId}`, {
        headers: {
          token:
            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJpcHM5aUtaNWlQIiwidXNlcm5hbWUiOiJkdWRlIiwiZW1haWwiOiJCQU1JQVlPOTBAR01BSUwuQ09NIiwiZnVsbE5hbWUiOiJMQVdBTCBBWU9CQU1JIiwiaWF0IjoxNjUxMDgwNTc2LCJleHAiOjE2NTEwODc3NzZ9.ZpcZ9HNo1y-AyBsKNUUlJLYF09ovN42-qen9JfXMTk4",
        },
      });
  ...
  return (
    ...
    >
      ...
      <View style={styles.chatInfo}>
        ...
        <View>
          {/* hint message */}
          <Text style={styles.chatHintMessage}>
            Hey Oga mi, trust all is well, I called you
          </Text>
        </View>
      </View>
    </TouchableOpacity>
