...
const Getstarted = ({navigation}) => {
  return (
    <Mainwrapper>
      <Text style={{textAlign: "center", ...fontsize.bbsmall,...FONTS.medium, lineHeight: 25, marginTop: RFValue(30), marginHorizontal: 40}}>The coolest & more convenient way to <Text style={{color: COLORS.blue6}}>withdraw</Text> your cash.</Text>
