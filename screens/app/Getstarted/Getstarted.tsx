...
const Getstarted = ({navigation}) => {
  return (
    <Mainwrapper>
      <Text style={{textAlign: "center", ...fontsize.bbsmall,...FONTS.medium, lineHeight: 25, marginTop: RFValue(40)}}>The coolest & more convenient way to <Text style={{color: COLORS.blue6}}>withdraw</Text> your cash.</Text>

    <View style={{ justifyContent: "center", alignItems: "center"}}>
        <View style={{width: 340, height: 340, backgroundColor: COLORS.purple3, marginTop: RFValue(55), marginBottom: 75}} />
    </View>
