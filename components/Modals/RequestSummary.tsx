...
import { getFirstName, nameSplitter, nameSplitToTwo } from '../../utils/nameSplitter'
...
return (
    ...
    <View style={{flexDirection: "row", justifyContent: 'space-between'}}>
      ...
      <Text style={{...fontsize.smallest, ...FONTS.medium, color: COLORS.purple4}}>+N{amountFormatter(baseCharge)}</Text>
    </View>
    ...
    <View style={{flexDirection: "row", justifyContent: 'space-between'}}>
      ...
      <Text style={{...fontsize.smallest, ...FONTS.medium, color: COLORS.purple4}}>+N{amountFormatter(addedFee)}</Text>
    </View>
